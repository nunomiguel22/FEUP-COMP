...
public class io {
	...
	/*
	 * final static int readln() { int a=0; try { BufferedReader teclado = new
	 * BufferedReader(new InputStreamReader(System.in)); a =
	 * Integer.parseInt(teclado.readLine()); } catch (java.io.IOException e) {
	 * System.out.println(e); System.exit(1); } return a; }
	 */
